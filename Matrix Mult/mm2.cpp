...
int main(int argc, char *arg[])
{
	...
	const size_t global_size_init[2] = {(size_t)p, (size_t)q};
	const size_t global_size[2] = {(size_t)q,(size_t)p};
	const size_t local_size[2] = {16, 16};
	status = clEnqueueNDRangeKernel(command_queue, kernel_init, 2, NULL, global_size_init, local_size, 0, NULL, NULL);
